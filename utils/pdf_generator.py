...
def generate_invoice_pdf(invoice, customer, plan_name="Subscription Service"):
    ...
    # Colors
    primary_color = (33, 86, 143) # Adams Professional Blue
    text_color = (31, 41, 55)     # Dark Gray
    
    # Header
    pdf.set_font("Helvetica", "B", 24)
    pdf.set_text_color(*primary_color)
    pdf.cell(0, 15, "ADAMS PROPERTY CARE", ln=True, align="L")
    
    pdf.set_font("Helvetica", "B", 10)
    pdf.set_text_color(100, 100, 100)
    pdf.cell(0, 5, "PROFESSIONAL PROPERTY MAINTENANCE", ln=True, align="L")
    pdf.ln(10)
    ...
    pdf.cell(0, 10, "Thank you for choosing Adams Property Care!", align="C", ln=True)
    ...
    with tempfile.NamedTemporaryFile(delete=False, suffix=".pdf") as tmp:
        pdf.output(tmp.name)
        return FileResponse(tmp.name, filename=f"Adams_Invoice_{invoice.square_invoice_id}.pdf", media_type="application/pdf")
